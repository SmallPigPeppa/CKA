...
def forward_features_small(model, x):
    ...
    x2_0 = model.small_net[4][0](x1_2)
    x2_1 = model.small_net[4][1](x2_0)
    x2_2 = model.small_net[4][2](x2_1)
    x2_3 = model.small_net[4][3](x2_2)

    x2_3 = F.interpolate(x2_3, size=model.unified_size, mode='bilinear')
...
def forward_features_large(model, x):
    ...
    x2_0 = model.large_net[5][0](x1_2)
    x2_1 = model.large_net[5][1](x2_0)
    x2_2 = model.large_net[5][2](x2_1)
    x2_3 = model.large_net[5][3](x2_2)
    x2_3 = F.interpolate(x2_3, size=model.unified_size, mode='bilinear')
...
def main():
    ...
    val_ckpt_path = '/share/wenzhuoliu/code/test-code/CKA/supervised-ckpt/supervised-l3.ckpt'
    batch_size = 128
    dataset_size = 1280
    num_sweep = 10
    num_features = 17
