...
class MSNetPL2(pl.LightningModule):
    def __init__(self, args):
        super().__init__()
        self.args = args
...
def main():
    ...
    val_ckpt_path2 = '/share/wenzhuoliu/code/test-code/CKA/supervised-ckpt/supervised-baseline32.ckpt'
    batch_size = 128
    dataset_size = 1280
    num_sweep = 10
    num_features = 17
    ...
    model2 = MSNetPL2.load_from_checkpoint(checkpoint_path=val_ckpt_path2, args=None).encoder.resnet
    model2.cuda()
    model2.eval()
    ...
    with torch.no_grad():
        for sweep in range(num_sweep):
            ...
            for images, targets in tqdm(data_loader):
                ...
                features1 = forward_features(model2, images_small)
